...
<head>
	...
	<title>Add Alumni | Alumni Database</title>
	<meta name="description" content="Page to add alumni to the database. Must fill in name at the very least. Other informations are major, graduation year, industry, company, position, and location.">
...
<body>
	...
	<div class="container">
		<div class="row">
			<h1 class="col-12 mt-4 mb-4">Add an Alumni</h1>
		</div> <!-- .row -->
	</div> <!-- .container -->
	...
	<div class="container">
		...
		<form action="add_confirmation.php" method="POST">
            ...
            <div class="form-group row">
				<label for="name-id" class="col-2 col-form-label text-right mb-3">Name: <span class="text-danger">*</span></label>
				<div class="col-9">
			...
			<div class="form-group row">
				<label for="company-id" class="col-2 col-form-label text-right mb-3">Company:</label>
				<div class="col-9">
            ...
            <div class="form-group row">
				<label for="position-id" class="col-2 col-form-label text-right mb-3">Position:</label>
				<div class="col-9">
					<input type="text" class="form-control" id="position-id" name="position">
				</div>
			</div> <!-- .form-group -->

            <div class="form-group row">
				<label for="location-id" class="col-2 col-form-label text-right mb-3">Location:</label>
				<div class="col-9">
